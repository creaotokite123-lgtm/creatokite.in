...
function CASRing({ cas = 0, badge = 'REVIEW' }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
      ...
      <span style={{
        fontSize: 11, padding: '3px 10px', borderRadius: 99, fontWeight: 800, letterSpacing: 0.5,
        color: bm.color, background: bm.bg, border: `1px solid ${bm.border}`
      }}>{bm.label}</span>
    </div>
  );
}
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8, flexWrap: 'wrap' }}>
          ...
          <span style={{
            ...
            background: 'rgba(230,95,43,0.12)', color: 'var(--acc)', border: '1px solid rgba(230,95,43,0.3)', fontWeight: 800, letterSpacing: 0.5
          }}>AI-POWERED</span>
        </div>
          ...
          <div style={{ marginTop: 16, padding: 20, background: 'var(--s2)', borderRadius: 14, border: '1px solid var(--border)' }}>
            {STEPS.map((s, i) => (
              <div key={i} style={{
                ...
                <span style={{
                  fontSize: 12.5, fontWeight: i === stepIdx ? 800 : 500,
        ...
        {casData && !analyzing && (
          <div style={{ marginTop: 20 }}>
            <div style={{
              padding: '12px 16px', borderRadius: 12, marginBottom: 20, fontSize: 12.5, lineHeight: 1.6,
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 20, alignItems: 'start' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, background: 'var(--s2)', padding: 20, borderRadius: 16, border: '1px solid var(--border)' }}>
                ...
                <div style={{ textAlign: 'center' }}>
                  ...
                  <span style={{
                    fontWeight: 800, color: RISK_CLR[casData.riskLevel] || 'var(--t1)',
                ...
                {[casData.igData, casData.ytData].filter(Boolean).map((d, i) => (
                  <div key={i} style={{
                    width: '100%', background: 'var(--s1)', borderRadius: 12,
        ...
        {user?.socialAnalyzed && !casData && !analyzing && (
          <div style={{
            marginTop: 16, padding: '16px 20px', background: 'var(--s2)', borderRadius: 16,
      ...
      {(user?.platforms?.instagram?.followers > 0 || user?.platforms?.youtube?.followers > 0) && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18, flexWrap: 'wrap', gap: 10 }}>
            ...
            <span style={{
              fontSize: 11, color: 'var(--t2)', background: 'var(--s2)',
